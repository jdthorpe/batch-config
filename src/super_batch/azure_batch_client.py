...
from SparseSC.utils.azure_batch_client import BatchConfig, run_batch_job
...
def run_batch_job(config: BatchConfig, wait=True) -> None:
    r"""
...
if __name__ == "__main__":
    ...
    run_batch_job(config_module.config)
